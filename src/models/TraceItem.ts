...
export class Trace {
    ...
    public static GetTrace = (setState) => Get(Trace.urlTrace, setState)
}
...
export class TraceItem implements ITraceItem {
    ...
    public static From(obj: object): TraceItem {
    ...
    public static Get = (id, setState) => {
        !!id && Get(TraceItem.getUrl(id), rsb => setState(rsb.data))
    }
    ...
    public Put = (setState) => this.PutCheck() && this.LocalVersionModified() && Put(TraceItem.url, this, setState)
    public Delete = setState => !!this.traceId && Delete(TraceItem.url, this, setState)
